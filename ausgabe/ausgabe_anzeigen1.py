...
def ausgabe(eingabe:str, ausgabe_programm, ausgabe_ki, eingabetextfeld):
    from ausgabe.ausgabe_generieren4 import ausgabe_generieren
    from ausgabe.eingabe_bearbeiten2 import input_ersetzten
    import threading
    ...
    def programm_ergebnis():
        ...
        for ausgabe, zeile in ausgabe_generieren(eingabe, ausgabe_ki):
            if ausgabe == "fertig":
                ...
                ausgabe_programm.config(state="disabled") # Setzt anschließen wieder auf Status: nicht bearbeitbar
                ausgabe_programm.update() # Führt die Vorherigen Commands aus
